...
Partial Class A_Money
    ...
    Public Shared Function ReturnUnit(str1 As String) As String
        ...
        Dim rs As New ADODB.Recordset
        str1 = ""
        rs = cPConn.Execute("Select * from Money where zDeptCode='" & HttpContext.Current.Session("usercode") & "' and cPhoneNumber='" & HttpContext.Current.Session("iphone") & "'")
        If rs.RecordCount <> 0 Then
            For i = 1 To rs.RecordCount
