...
Partial Class A_Upload1
    Inherits System.Web.UI.Page

    Private Sub A_Upload1_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim AtterFileName = Session("QKCode") + "." + SplitFileName(1)



        Try
            client.PutObject("aiwei-image", "TZ/" & AtterFileName, fileStream)
            cPConn.Execute("update dbQK set cURL='https://aiwei-image.oss-cn-beijing.aliyuncs.com/TZ/" & AtterFileName & "' where cCode='" & Session("QKCode") & "'")
