...
Err_Hand:
    ...
    Public Shared Function GetWX(str1 As String) As String
        ...
        'Dim nickname = JSON.eval("JSON=" & strReturn & ";JSON.nickname;")

        'JSON = Nothing
        'Return openid

        'openid = "oVaqwwNCW1Fz_wVKWBbR_-RidGVY"
        ...
        If openid <> Nothing Then
            ...
            If rs.RecordCount <> 0 Then
                ...
                If HttpContext.Current.Session("iphone") <> Nothing Then
                    cPConn.Execute("update dbuser set binit=1,wxname='" & openid & "',wxheadimgurl ='" & headimgurl & "',wxnickname='" & nickname & "' where iPhoneNumber='" & HttpContext.Current.Session("iphone") & "'")
            ...
            Else
                ...
                Else
                    ...
                    cPConn.Execute("insert into dbuser(wxname,iphoneNumber,cClassName,wxnickname,wxheadimgurl,binit)values('" & openid & "','" & sBillCode & "','" & nickname & "','" & nickname & "','" & headimgurl & "',1)")
